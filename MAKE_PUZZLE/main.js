...
const INITIAL_STAGE_DATA = [
  ...
  {
    cols: 4, rows: 4, 
    start: { c: 0, r: 4 }, goal: { c: 4, r: 0 },
    walls: [{ c: 2, r: 2, type: "h" }, { c: 2, r: 2, type: "v" }],
    triangleSymbols: [{ c: 1, r: 1, count: 3 }, { c: 2, r: 2, count: 1 }],
    mustPasses: [{ c: 2, r: 2, type: "node" }, { c: 0, r: 2, type: "v" }, { c: 4, r: 2, type: "v" }]
  },
  // Level 2: "RGB Separation"
  {
    cols: 5, rows: 5,
    start: { c: 2, r: 5 }, goal: { c: 2, r: 0 },
    squares: [
      { c: 0, r: 0, color: 5 }, { c: 1, r: 0, color: 5 }, { c: 0, r: 1, color: 5 }, 
      { c: 4, r: 0, color: 7 }, { c: 3, r: 0, color: 7 }, { c: 4, r: 1, color: 7 },
      { c: 2, r: 2, color: 4 }, { c: 0, r: 4, color: 4 }, { c: 4, r: 4, color: 4 }
    ],
    walls: []
  },
  // Level 3: "Starry Night"
  {
    ...
    start: { c: 0, r: 4 }, goal: { c: 4, r: 0 },
    stars: [
      { c: 0, r: 0, color: 5 }, { c: 3, r: 3, color: 5 }, 
      { c: 3, r: 0, color: 2 }, { c: 0, r: 3, color: 2 }, 
      { c: 1, r: 1, color: 4 }, { c: 2, r: 2, color: 4 }
    ],
    walls: [{ c: 2, r: 1, type: "v" }, { c: 2, r: 2, type: "v" }]
  },
  // Level 4: "Tetris Cram"
  {
    cols: 4, rows: 4,
    start: { c: 0, r: 0 }, goal: { c: 4, r: 4 },
    polyominoes: [
      { c: 1, r: 0, shape: [[1,1,1],[0,1,0]], color: 4 },
      { c: 2, r: 3, shape: [[1,1],[1,1]], color: 4 }
    ],
    walls: []
  },
  // Level 5: "The Eraser"
  {
    cols: 3, rows: 3,
    start: { c: 0, r: 3 }, goal: { c: 3, r: 0 },
    squares: [{ c: 0, r: 0, color: 1 }, { c: 2, r: 0, color: 0 }, { c: 1, r: 1, color: 1 }],
    
    mustPasses: [{ c: 1, r: 2, type: "node" }]
  },
  // Level 6: "Combo Breaker"
  {
    cols: 5, rows: 5,
    start: { c: 0, r: 5 }, goal: { c: 5, r: 0 },
    polyominoes: [{ c: 2, r: 2, shape: [[1],[1],[1]], color: 4 }],
    stars: [{ c: 0, r: 0, color: 5 }, { c: 1, r: 0, color: 5 }, { c: 4, r: 4, color: 2 }],
    squares: [{ c: 3, r: 4, color: 2 }]
  },
  // Level 7: "Triangle Highway"
  {
    cols: 6, rows: 4,
    start: { c: 0, r: 2 }, goal: { c: 6, r: 2 },
    triangleSymbols: [
      { c: 1, r: 1, count: 2 }, { c: 2, r: 1, count: 2 }, { c: 3, r: 1, count: 2 }, { c: 4, r: 1, count: 2 },
      { c: 1, r: 2, count: 2 }, { c: 2, r: 2, count: 2 }, { c: 3, r: 2, count: 2 }, { c: 4, r: 2, count: 2 }
    ]
  },
  // Level 9: "The Sacrificial Lamb"
  {
    cols: 4, rows: 4,
    start: { c: 0, r: 4 }, goal: { c: 4, r: 0 },
    stars: [{ c: 0, r: 0, color: 5 }, { c: 0, r: 1, color: 5 }, { c: 0, r: 2, color: 5 }],
    squares: [{ c: 3, r: 3, color: 2 }, { c: 2, r: 3, color: 1 }],
    eliminators: [{ c: 2, r: 1 }]
  },
  // Level 10: "The Final Exam"
  {
    cols: 6, rows: 6,
    start: { c: 0, r: 6 }, goal: { c: 6, r: 0 },
    walls: [{c:3,r:3,type:'h'}, {c:3,r:3,type:'v'}, {c:2,r:3,type:'h'}],
    squares: [{c:0,r:0,color:0}, {c:5,r:5,color:1}],
    stars: [{c:0,r:5,color:5}, {c:1,r:5,color:5}],
    triangleSymbols: [{c:3,r:2,count:3}],
    mustPasses: [{c:3,r:3,type:'node'}],
    polyominoes: [{c:5,r:0,shape:[[1,1],[1,0]],color:4}]
  }
];
